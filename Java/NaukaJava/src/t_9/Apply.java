...
static String s = "Idzie grzes przez wies worek z piaskiem niesie";
	...
	Apply.processor(new Spliter(), s);  //wzorzec projektowy strategy - zachowanie metody zalezy od obiektu argumentu (gówna czesc metody jest taka sama, a szczegóy zaleza od typu argumentu wejsciowego)
